...
void vPortSuppressTicksAndSleep(TickType_t xExpectedIdleTime)
{
    ...
    static uint64_t xOstimerStartValue = 0;
    ...
    else
    {
        ...
        else
        {
            ...
            ulCompleteTickPeriods =
                xExpectedIdleTime - 1 -
                ((OSTIMER_GetCurrentTimerValue(pxOstimerBase) - xOstimerStartValue) / ulLPTimerCountsForOneTick);
        }
