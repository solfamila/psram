...
/** \file mcux_psa_els_pkc_cipher.c
 *
...
psa_status_t els_pkc_transparent_cipher_encrypt(
...
psa_status_t els_pkc_transparent_cipher_abort(els_pkc_transparent_cipher_operation_t *operation)
{
   psa_status_t status;
...
psa_status_t els_pkc_transparent_cipher_decrypt_setup(
...
psa_status_t els_pkc_transparent_cipher_encrypt_setup(
    els_pkc_transparent_cipher_operation_t *operation,
    const psa_key_attributes_t * attributes,
    const uint8_t * key_buffer,
    size_t key_buffer_size,
...
psa_status_t els_pkc_transparent_cipher_finish(
    els_pkc_transparent_cipher_operation_t *operation,
    uint8_t *output,
    size_t output_size,
    size_t *output_length)
...
psa_status_t els_pkc_transparent_cipher_update(
    els_pkc_transparent_cipher_operation_t *operation,
    const uint8_t *input,
    size_t input_length,
    uint8_t *output,
