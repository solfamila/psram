...
#ifndef MCUX_PSA_ELS_PKC_OPAQUE_INIT_H
#define MCUX_PSA_ELS_PKC_OPAQUE_INIT_H

/** \file mcux_psa_els_pkc_opaque_init.h
 *
 ...
 *          failure
 */
psa_status_t els_pkc_opaque_free(void);
...
#endif /* MCUX_PSA_ELS_PKC_OPAQUE_INIT_H */
