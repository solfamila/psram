 ...
 * @{
 */
/*! @brief SDADC driver version 2.0.1. */
#define FSL_SDADC_DRIVER_VERSION (MAKE_VERSION(2, 0, 1))
/*!
 * @}
 */

/*! @brief Macros are used to configure decimator volume. */
#define SDADC_DECIMATOR_VOL_CTRL_P_MASK(offset) \
    (uint32_t)((uint32_t)SDADC_DECIMATOR_CTL_2_VOL_CTRL_P_0_MASK << ((uint32_t)offset))
#define SDADC_DECIMATOR_VOL_CTRL_P_SHIFT(offset) \
    (uint32_t)((uint32_t)SDADC_DECIMATOR_CTL_2_VOL_CTRL_P_0_SHIFT + ((uint32_t)offset))
...
#define SDADC_DECIMATOR_VOL_CTRL_N_MASK(offset) \
    (uint32_t)((uint32_t)SDADC_DECIMATOR_CTL_2_VOL_CTRL_N_0_MASK << ((uint32_t)offset))
#define SDADC_DECIMATOR_VOL_CTRL_N_SHIFT(offset) \
    (uint32_t)((uint32_t)SDADC_DECIMATOR_CTL_2_VOL_CTRL_N_0_SHIFT + ((uint32_t)offset))
...
#define SDADC_DECIMATOR_SET_SPEED_P_MASK(offset) \
    (uint32_t)((uint32_t)SDADC_DECIMATOR_CTL_4_SET_SPEED_P_0_MASK << ((uint32_t)offset * 4UL))
#define SDADC_DECIMATOR_SET_SPEED_P_SHIFT(offset) \
    (uint32_t)((uint32_t)SDADC_DECIMATOR_CTL_4_SET_SPEED_P_0_SHIFT + ((uint32_t)offset * 4UL))
...
#define SDADC_DECIMATOR_SET_SPEED_N_MASK(offset) \
    (uint32_t)((uint32_t)SDADC_DECIMATOR_CTL_4_SET_SPEED_N_0_MASK << ((uint32_t)offset * 4UL))
#define SDADC_DECIMATOR_SET_SPEED_N_SHIFT(offset) \
    (uint32_t)((uint32_t)SDADC_DECIMATOR_CTL_4_SET_SPEED_N_0_SHIFT + ((uint32_t)offset * 4UL))
...
#define SDADC_ADC_CTL_2_SET_DITHER_MASK(offset) \
    (uint32_t)((uint32_t)SDADC_ADC_CTL_2_SET_DITHER3_MASK << ((3UL - (uint32_t)offset) * 4UL))
#define SDADC_ADC_CTL_2_SET_DITHER_SHIFT(offset) \
    (uint32_t)((uint32_t)SDADC_ADC_CTL_2_SET_DITHER3_SHIFT + ((3UL - (uint32_t)offset) * 4UL))
...
#define SDADC_FIFO_WATERMARK_CTL_P_MASK(offset) \
    (uint32_t)((uint32_t)SDADC_FIFO_WATERMARK_CTL_WATERMARK_0_P_MASK << ((uint32_t)offset * 8UL))
#define SDADC_FIFO_WATERMARK_CTL_P_SHIFT(offset) \
    (uint32_t)((uint32_t)SDADC_FIFO_WATERMARK_CTL_WATERMARK_0_P_SHIFT + ((uint32_t)offset * 8UL))
...
#define SDADC_FIFO_WATERMARK_CTL_N_MASK(offset) \
    (uint32_t)((uint32_t)SDADC_FIFO_WATERMARK_CTL_WATERMARK_0_N_MASK << ((uint32_t)offset * 8UL))
#define SDADC_FIFO_WATERMARK_CTL_N_SHIFT(offset) \
    (uint32_t)((uint32_t)SDADC_FIFO_WATERMARK_CTL_WATERMARK_0_N_SHIFT + ((uint32_t)offset * 8UL))
                                                     ...
                                                     bool enable)
{
    if (enable)
    {
        ...
        {
            base->ADC_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_ADCP_POWER_ENABLE_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->ADC_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_ADCN_POWER_ENABLE_SHIFT));
        }
        else
        {
            base->ADC_CTL_0 |= ((0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_ADCP_POWER_ENABLE_SHIFT)) |
                                (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_ADCN_POWER_ENABLE_SHIFT)));
        }
    }
    else
    {
...
static inline void SDADC_ConfigureReferenceMode(SDADC_Type *base, sdadc_ref_mode_t referenceMode)
{
    base->REF_CTL =
        ((base->REF_CTL & (~(SDADC_REF_CTL_FAST_REF_ENABLE_MASK | SDADC_REF_CTL_PWR_FAST_REF_ENABLE_MASK))) |
         (((((uint32_t)referenceMode & 0x2U) != 0UL) ? SDADC_REF_CTL_PWR_FAST_REF_ENABLE_MASK : 0U) |
          ((((uint32_t)referenceMode & 0x1U) != 0UL) ? SDADC_REF_CTL_FAST_REF_ENABLE_MASK : 0U)));
}
                                              ...
                                              sdadc_channel_mode_t mode)
{
    ...
    {
        base->ADC_CTL_1 &= ~(0x01UL << ((uint32_t)number + SDADC_ADC_CTL_1_DIFF_ENABLE_SHIFT));
    }
    else
    {
        base->ADC_CTL_1 |= (0x01UL << ((uint32_t)number + SDADC_ADC_CTL_1_DIFF_ENABLE_SHIFT));
                                                      ...
                                                      bool enable)
{
    if (enable)
    {
        if (type == kSDADC_Channel_PSide_Type)
        {
            base->ADC_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_COMP_ADCP_ENABLE_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->ADC_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_COMP_ADCN_ENABLE_SHIFT));
        }
        else
        {
            base->ADC_CTL_0 |= ((0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_COMP_ADCP_ENABLE_SHIFT)) |
                                (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_COMP_ADCN_ENABLE_SHIFT)));
        }
    }
    else
    {
                                                      ...
                                                      bool enable)
{
    if (enable)
    {
        if (type == kSDADC_Channel_PSide_Type)
        {
            base->ADC_CTL_1 |= (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_1_DCLOOP_P_ANA_ENABLE_SHIFT));
            base->DC_LOOP_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_DC_LOOP_CTL_0_DCLOOP_P_ENABLE_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->ADC_CTL_1 |= (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_1_DCLOOP_N_ANA_ENABLE_SHIFT));
            base->DC_LOOP_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_DC_LOOP_CTL_0_DCLOOP_N_ENABLE_SHIFT));
        }
        else
        {
            base->ADC_CTL_1 |= ((0x1UL << ((uint32_t)number + SDADC_ADC_CTL_1_DCLOOP_P_ANA_ENABLE_SHIFT)) |
                                (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_1_DCLOOP_N_ANA_ENABLE_SHIFT)));
            base->DC_LOOP_CTL_0 |= ((0x1UL << ((uint32_t)number + SDADC_DC_LOOP_CTL_0_DCLOOP_P_ENABLE_SHIFT)) |
                                    (0x1UL << ((uint32_t)number + SDADC_DC_LOOP_CTL_0_DCLOOP_N_ENABLE_SHIFT)));
        }
    }
    else
    {
                                                        ...
                                                        bool enable)
{
    if (enable)
    {
        if (type == kSDADC_Channel_PSide_Type)
        {
            base->DECIMATOR_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_0_DCFILTI_P_ENABLE_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->DECIMATOR_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_0_DCFILTI_N_ENABLE_SHIFT));
        }
        else
        {
            base->DECIMATOR_CTL_0 |= ((0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_0_DCFILTI_P_ENABLE_SHIFT)) |
                                      (0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_0_DCFILTI_N_ENABLE_SHIFT)));
        }
    }
    else
    {
                                                            ...
                                                            bool enable)
{
    if (enable)
    {
        if (type == kSDADC_Channel_PSide_Type)
        {
            base->DECIMATOR_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_0_POL_INV_P_ENABLE_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->DECIMATOR_CTL_0 |= (0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_0_POL_INV_N_ENABLE_SHIFT));
        }
        else
        {
            base->DECIMATOR_CTL_0 |= ((0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_0_POL_INV_P_ENABLE_SHIFT)) |
                                      (0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_0_POL_INV_N_ENABLE_SHIFT)));
        }
    }
    else
    {
...
{
    uint8_t registerOffset = (uint32_t)number / 2U;
    uint8_t bitfieldOffset = (uint32_t)number % 2U * 16U;

    if (type == kSDADC_Channel_PSide_Type)
    {
        (*(((uint32_t *)(&(base->DECIMATOR_CTL_2))) + registerOffset)) =
            (((*(((volatile uint32_t *)(&(base->DECIMATOR_CTL_2))) + registerOffset)) &
              (~(SDADC_DECIMATOR_VOL_CTRL_P_MASK(bitfieldOffset)))) |
    ...
    else if (type == kSDADC_Channel_NSide_Type)
    {
        (*(((uint32_t *)(&(base->DECIMATOR_CTL_2))) + registerOffset)) =
            (((*(((volatile uint32_t *)(&(base->DECIMATOR_CTL_2))) + registerOffset)) &
              (~(SDADC_DECIMATOR_VOL_CTRL_N_MASK(bitfieldOffset)))) |
                                               ...
                                               bool reset)
{
    if (reset)
    {
        if (type == kSDADC_Channel_PSide_Type)
        {
            base->ADC_CTL_0 &= ~(0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_RST_AN_ADCP_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->ADC_CTL_0 &= ~(0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_RST_AN_ADCN_SHIFT));
        }
        else
        {
            base->ADC_CTL_0 &= ~((0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_RST_AN_ADCP_SHIFT)) |
                                 (0x1UL << ((uint32_t)number + SDADC_ADC_CTL_0_RST_AN_ADCN_SHIFT)));
        }
    }
    else
    {
                                               ...
                                               bool reset)
{
    if (reset)
    {
        if (type == kSDADC_Channel_PSide_Type)
        {
            base->DECIMATOR_CTL_1 &=
                ~(0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_1_FUNC_LOCAL_RST_AN_DEC_P_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->DECIMATOR_CTL_1 &=
                ~(0x1UL << ((uint32_t)number + SDADC_DECIMATOR_CTL_1_FUNC_LOCAL_RST_AN_DEC_N_SHIFT));
        }
        else
        {
            base->DECIMATOR_CTL_1 &=
                                                       ...
                                                       bool reset)
{
    if (reset)
    {
        ...
        {
            base->DC_LOOP_CTL_1 &=
                ~(0x1UL << ((uint32_t)number + SDADC_DC_LOOP_CTL_1_FUNC_LOCAL_RST_AN_DCLOOP_P_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->DC_LOOP_CTL_1 &=
                ~(0x1UL << ((uint32_t)number + SDADC_DC_LOOP_CTL_1_FUNC_LOCAL_RST_AN_DCLOOP_N_SHIFT));
        }
        else
        {
            base->DC_LOOP_CTL_1 &=
    ...
    else
    {
        if (type == kSDADC_Channel_PSide_Type)
        {
            base->DC_LOOP_CTL_1 |= (0x1UL << ((uint32_t)number + SDADC_DC_LOOP_CTL_1_FUNC_LOCAL_RST_AN_DCLOOP_P_SHIFT));
        }
        else if (type == kSDADC_Channel_NSide_Type)
        {
            base->DC_LOOP_CTL_1 |= (0x1UL << ((uint32_t)number + SDADC_DC_LOOP_CTL_1_FUNC_LOCAL_RST_AN_DCLOOP_N_SHIFT));
        }
        else
        {
            base->DC_LOOP_CTL_1 |=
                                                   ...
                                                   sdadc_fifo_reset_operation_t operation)
{
    ...
    {
        base->FIFO_WR_RD_CTL |=
            ((uint32_t)operation << (((uint32_t)number * 4U) + SDADC_FIFO_WR_RD_CTL_WR_0_P_RST_SHIFT));
    }
    else if (type == kSDADC_Channel_NSide_Type)
    {
        base->FIFO_WR_RD_CTL |=
            ((uint32_t)operation << (((uint32_t)number * 4U) + SDADC_FIFO_WR_RD_CTL_WR_0_N_RST_SHIFT));
    }
    else
    {
        base->FIFO_WR_RD_CTL |=
                                                               ...
                                                               sdadc_channel_type_t type)
{
    ...
    if (type == kSDADC_Channel_PSide_Type)
    {
        temp = (uint8_t)(uint32_t)(((*(((volatile uint32_t *)(&(base->FIFO_ENTRIES_AVAIL_0))) + registerOffset)) >> bitfieldOffset) & 
                                   SDADC_FIFO_ENTRIES_AVAIL_MASK);
    }
    else if (type == kSDADC_Channel_NSide_Type)
    {
        temp = (uint8_t)(uint32_t)(((*(((volatile uint32_t *)(&(base->FIFO_ENTRIES_AVAIL_0))) + registerOffset)) >> (bitfieldOffset + 8U)) & 
                                   SDADC_FIFO_ENTRIES_AVAIL_MASK);
    }
    else
    {
        /* Empty branch to avoid MISRA C-2012 issue. */
    }
                                                       ...
                                                       sdadc_channel_type_t type)
{
    ...
    if (type == kSDADC_Channel_PSide_Type)
    {
        offset = (uint32_t)number * 2U;
    }
    else if (type == kSDADC_Channel_NSide_Type)
    {
        offset = (uint32_t)number * 2U + 1U;
    }
    else
    {
        assert(false);
    ...
    return (((*(((volatile uint32_t *)(&(base->FIFO_0_P))) + offset)) & SDADC_FIFO_MASK) >> SDADC_FIFO_SHIFT);
}
